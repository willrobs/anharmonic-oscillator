...
def probd(spring_const,mass,la,lattice_spacing,num_config,num_lat_points,d_volume,pdsets):
    mu=spring_const
    m=mass
    a=lattice_spacing
    niter=num_config
...
probd(spring_const,mass,la,lattice_spacing,num_config,num_lat_points,d_volume,pdsets)
